...
public class Atendente  implements java.io.Serializable {
    ...
    public Atendente(Empresa empresa, String funcpf, String funlogin, int funsenha, String funnome, String funrg) {
    ...
    public Atendente(Empresa empresa, String funcpf, String funlogin, int funsenha, String funnome, String funrg, String tipouser) {
       this.empresa = empresa;
       this.funcpf = funcpf;
       this.funlogin = funlogin;
       this.funsenha = funsenha;

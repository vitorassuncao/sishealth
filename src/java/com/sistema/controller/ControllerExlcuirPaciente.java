...
import com.sistema.model.dao.PacienteDao;
...
public class ControllerExlcuirPaciente  extends HttpServlet{
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</html>");
            */
            response.sendRedirect("http://localhost:8080/ProjetoWeb/confirmacao.jsp");
        }
    }
